...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='systemmsgsubscription',
            name='users',
            field=models.ManyToManyField(related_name='system_msg_subscriptions', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='usermsgsubscription',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_msg_subscription', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AddIndex(
            model_name='messageuserread',
