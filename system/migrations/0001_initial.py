    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode_type', models.SmallIntegerField(choices=[(0, 'Or mode'), (1, 'And mode')], default=0, help_text='Permission mode, and the mode indicates that the data needs to satisfy each rule in the rule list at the same time, or the mode satisfies any rule', verbose_name='Data permission mode')),
                ...
                ('avatar', common.fields.image.ProcessedImageField(blank=True, null=True, upload_to=common.core.models.upload_directory_path, verbose_name='Avatar')),
                ('nickname', models.CharField(blank=True, max_length=150, verbose_name='Nickname')),
                ('gender', models.IntegerField(choices=[(0, 'Unknown'), (1, 'Male'), (2, 'Female')], default=0, verbose_name='Gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated time')),
                ('description', models.CharField(blank=True, max_length=256, null=True, verbose_name='Description')),
                ('menu_type', models.SmallIntegerField(choices=[(0, 'Directory'), (1, 'Menu'), (2, 'Permission')], default=0, verbose_name='Menu type')),
                ('name', models.CharField(max_length=128, unique=True, verbose_name='Component name or permission code')),
                ...
                ('dept_belong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='dept_belong_query', to='system.deptinfo', verbose_name='Data ownership department')),
                ('modifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='modifier_query', to=settings.AUTH_USER_MODEL, verbose_name='Modifier')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='system.menu', verbose_name='Parent menu')),
            ],
            options={
                'verbose_name': 'Menu',
        ...
        migrations.AddField(
            model_name='datapermission',
            name='menu',
            field=models.ManyToManyField(blank=True, help_text='If a menu exists, it only applies to the selected menu permission', null=True, to='system.menu', verbose_name='Menu'),
        ),
        migrations.CreateModel(
            name='MenuMeta',
            fields=[
                ...
                ('is_keepalive', models.BooleanField(default=True, help_text='When enabled, the entire state of the page is saved, and when refreshed, the state is cleared', verbose_name='Keepalive')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Is active')),
                ('access', models.BooleanField(default=False, help_text='Allows API interfaces to access this config', verbose_name='API access')),
                ('key', models.CharField(max_length=255, unique=True, verbose_name='Config name')),
                ('inherit', models.BooleanField(default=False, help_text='Allows users to inherit this config', verbose_name='User inherit')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('dept_belong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='dept_belong_query', to='system.deptinfo', verbose_name='Data ownership department')),
                ('modifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='modifier_query', to=settings.AUTH_USER_MODEL, verbose_name='Modifier')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, null=True, verbose_name='Updated time')),
                ('description', models.CharField(blank=True, max_length=256, null=True, verbose_name='Description')),
                ('filepath', models.FileField(blank=True, null=True, upload_to=common.core.models.upload_directory_path, verbose_name='Filepath')),
                ('file_url', models.URLField(blank=True, help_text='Usually an address accessible to the outside Internet', max_length=255, null=True, verbose_name='Internet URL')),
                ...
                ('is_tmp', models.BooleanField(default=False, help_text='Temporary files are automatically cleared by scheduled tasks', verbose_name='Tmp file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_type', models.SmallIntegerField(choices=[(0, 'Username and password'), (1, 'SMS verification code'), (2, 'Email verification code'), (4, 'Wechat scan code'), (9, 'Unknown')], default=0, verbose_name='Login type')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='Creator')),
                ('dept_belong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='dept_belong_query', to='system.deptinfo', verbose_name='Data ownership department')),
                ('modifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', related_query_name='modifier_query', to=settings.AUTH_USER_MODEL, verbose_name='Modifier')),
            ],
